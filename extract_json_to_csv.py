...
json_url = "https://raw.githubusercontent.com/NAIST-SE/DevGPT/main/snapshot_20230817/20230817_131244_commit_sharings.json"
...
def extract_json_to_csv(json_data):
    ...
    with open("817_chatgpt_sharing_urls.csv", "w", newline="", encoding="utf-8") as csvfile:
